        ...
        Pass {
            ...
            half4 frag(Varyings input) : SV_Target
			{
				...
				*/
                ...
                // Blend
                float3 finalRampCol = rampColor * (pow(reflectLumin, 1.5) + 0.05);	// Ramp?色受反射?像明度影?很大
                ...
                float finalAlpha = _BubbleAlpha * (reflectLumin * 0.5 + 0.5) + fresnel * 0.2;	//透明度受反射?像明度 ??厚度影?
