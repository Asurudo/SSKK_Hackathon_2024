...
{
    private RTHandle rtAttachmentHandle;
    ...
    public void Setup(RenderTextureDescriptor baseDescriptor, RTHandle handle)
    {
    ...
    public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
    {
        ...
        ConfigureTarget(rtAttachmentHandle);
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        cmd.SetGlobalTexture(TextureName, rtAttachmentHandle);
